...
namespace gps {
    ...
    void SkyBox::Draw(gps::Shader shader, glm::mat4 viewMatrix, glm::mat4 projectionMatrix, float fogDensity)
    {
        ...
        glUniform1f(glGetUniformLocation(shader.shaderProgram, "fogDensity"), (GLfloat)fogDensity);
